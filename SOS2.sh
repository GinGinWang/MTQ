...
python train.py  --autoencoder LSA --estimator SOS --epochs 2000 --dataset mnist  --lr 0.1 --hidden_size 2048 --batch_size 256 --num_blocks 5  --code_length 64  --PreTrained --select 6
...
python test.py  --autoencoder LSA --estimator SOS --dataset mnist   --hidden_size 2048 --num_blocks 10 --batch_size 256 --code_length 64 --score_normed --PreTrained --select 6