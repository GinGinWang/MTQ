...
# python test_temp.py  --autoencoder LSA --estimator EN --epochs 1000 --dataset mnist --batch_size 256 --code_length 64 --score_normed --PreTrained
...
# python test_temp.py  --autoencoder LSA --estimator EN  --epochs 1000 --dataset cifar10 --batch_size 256 --code_length 64 --score_normed --PreTrained

# Train LSA_EN 
# python train_temp.py  --autoencoder LSA --estimator EN --epochs 200 --dataset mnist  --lr 0.0001 --batch_size 256 --code_length 64 

# python test_temp.py  --autoencoder LSA --estimator EN  --dataset mnist --batch_size 256 --code_length 64 --score_normed



python test.py  --autoencoder LSA --estimator EN  --dataset mnist --batch_size 256 --code_length 64 --score_normed  --lr 0.0001 --epochs 200 
