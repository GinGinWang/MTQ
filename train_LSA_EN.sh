...
python test_temp.py  --autoencoder LSA --estimator EN --epochs 1000 --dataset mnist --batch_size 256 --code_length 64 --select 9
...
# python test_temp.py  --autoencoder LSA --estimator EN  --epochs 1000 --dataset cifar10 --batch_size 256 --code_length 64
