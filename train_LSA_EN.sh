...
# python test_temp.py  --autoencoder LSA   --dataset cifar10 --batch_size 256 --code_length 64 --score_normed

# python test_temp.py  --autoencoder LSA  --dataset mnist --batch_size 256 --code_length 64 --score_normed
