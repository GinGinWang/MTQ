...
python test.py  --autoencoder LSA --estimator SOS --dataset cifar10   --hidden_size 2048 --num_blocks 5 --batch_size 256 --code_length 64 --score_normed --PreTrained --n_class 7
