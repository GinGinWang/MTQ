...
# data_dir = '/home/jj27wang/novelty-detection/NovelDect_SoS/SoSLSA/data/fashion-mnist-gth'
data_dir ='/home/jj27wang/NewSoSLSA/data/fashion-mnist-gth'
class FMNIST_GTH(OneClassDataset):
    """
    Models fashion-mnist dataset for one class classification.
    """

    def __init__(self, n_class = 10, select= None):

        # type: (str) -> None
        """
        Class constructor.

        :param path: The folder in which to download fashion-mnist.
        """
        super(FMNIST_GTH, self).__init__()
    ...
    def val(self, normal_class):
        # type: (int) -> None
        """
        Sets fashion-mnist in validation mode.
        ...
        new_data_name = f'fashion-mnist_03_gth_{normal_class}_train_xy.npy'
    ...
    def test(self, normal_class, novel_ratio):
        ...
        test_data_name = f'fashion-mnist_m{normal_class}_e03_gth_test.npy'
    ...
    def __repr__(self):
        return f"ONE-CLASS fashion-mnist (normal class =  {self.normal_class} )"
