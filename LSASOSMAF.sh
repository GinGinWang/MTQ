...
# LSA_SOS
python train.py  --autoencoder LSA --estimator SOS --epochs 10000  --dataset mnist --select 2 --lr 0.0001 --hidden_size 1024 --batch_size 100 --num_blocks 10 --before_log_epoch 100

python test.py  --autoencoder LSA --estimator SOS --dataset mnist  --select 2 --hidden_size 1024 --num_blocks 10 

# python test.py  --autoencoder LSA --estimator SOS --epochs 1000 --dataset mnist  --select 2 --hidden_size 4096 --num_blocks 3 
