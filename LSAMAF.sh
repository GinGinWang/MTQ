...
python train.py  --autoencoder LSA --estimator MAF --epochs 1000 --dataset mnist --n_class 10

python test.py  --autoencoder LSA --estimator MAF --epochs 1000 --dataset mnist --score_normed --n_class 10

python test.py  --autoencoder LSA --estimator MAF --epochs 1000 --dataset mnist --n_class 10
