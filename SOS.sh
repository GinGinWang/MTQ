...
python train.py  --NoAutoencoder --estimator SOS --epochs 5 --dataset mnist --n_class 2

python test.py  --NoAutoencoder --estimator SOS --epochs 5 --dataset mnist --score_normed --n_class 2
