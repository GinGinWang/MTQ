python train.py  --autoencoder LSA --estimator MAF --epochs 10000 --dataset mnist  --lr 0.0001 --hidden_size 512 --batch_size 100 --num_blocks 5 --before_log_epoch 5000 --select 2 --PreTrained

python test.py  --autoencoder LSA --estimator MAF --dataset mnist   --hidden_size 128 --num_blocks 3 --batch_size 100 --select 2 --NoDecoder --PreTrained
