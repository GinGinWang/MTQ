...
python test.py --dataset kddcup --lr 0.00001  --batch_size 1024 --code_length 2 --epochs 50000 --select  1 --autoencoder LSA --estimator SOS  --Test --checkpoint b --log_step 1000 --hidden_size 2048 --MulObj
...
python test.py --dataset thyroid --lr 0.001  --batch_size 1024 --code_length 6 --epochs 50000 --select  1 --estimator SOS  --Train --log_step 2000 --hidden_size 2048
python test.py --dataset thyroid --lr 0.001  --batch_size 1024 --code_length 6 --epochs 50000 --select  1 --estimator SOS  --Test --checkpoint b --log_step 2000 --hidden_size 2048
