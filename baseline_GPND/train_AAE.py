...
def main(inliner_classes, total_classes):
    ...
    #         else:
    #             mnist_train += fold
    with open(f'{data_name}_traindata.pkl', 'rb') as pkl:
    ...
    torch.save(G.state_dict(),  f"{data_name}_{cl}Gmodel.pkl")
    torch.save(E.state_dict(),  f"{data_name}_{cl}Emodel.pkl")
    torch.save(D.state_dict(),  f"{data_name}_{cl}Dmodel.pkl")
    torch.save(ZD.state_dict(), f"{data_name}_{cl}ZDmodel.pkl")
