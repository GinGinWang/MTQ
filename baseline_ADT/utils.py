...
def save_transformation(tffeatures, feature_num, label, file_path):
    len_x = len(tffeatures)
    tffeatures_label = [(x, label) for x in tffeatures]
    np.save(file_path, tffeatures_label)
