...
python train.py  --autoencoder LSA  --epochs 1000 --dataset mnist --lr 0.01
...
python train.py  --autoencoder LSA  --epochs 1000 --dataset mnist --Combine_density --lr 0.01
...
##################################################
python train.py  --autoencoder LSA  --epochs 1000 --dataset cifar10  --lr 0.001
...
python train.py  --autoencoder LSA  --epochs 1000 --dataset cifar10 --Combine_density  --lr 0.001
