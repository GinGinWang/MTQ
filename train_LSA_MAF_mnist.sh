...
python train_temp.py  --autoencoder LSA --estimator MAF --epochs 1000 --dataset mnist  --lr 0.1 --hidden_size 1024 --batch_size 256 --num_blocks 10  --code_length 64 --before_log_epochs 100 
